...
/**
 * Kotlin wrapper around the libmpv C library via JNI.
 *
 * Vendored from mpv-android (https://github.com/mpv-android/mpv-android).
 * This class MUST stay at package `is.xyz.mpv` and keep the exact method
 * signatures because `libplayer.so` uses static JNI registration with
 * function names derived from this fully-qualified class name.
 */
@Suppress("unused")
object MPVLib {
    init {
    ...
    // ---------------------------------------------------------------
    // Lifecycle — called from JNI via libplayer.so
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // Format constants for observeProperty
    // ---------------------------------------------------------------
